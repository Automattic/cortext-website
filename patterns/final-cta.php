<?php
/**
 * Title: Cortext final call to action
 * Slug: cortext-website/final-cta
 * Categories: cortext, call-to-action
 * Description: A closing invitation to try Cortext or inspect the project.
 */
?>
<!-- wp:group {"align":"full","className":"final-cta section-shell","layout":{"type":"constrained"}} -->
