<?php
/**
 * Title: Cortext feature grid
 * Slug: cortext-website/feature-grid
 * Categories: cortext, columns
 * Description: Four product capabilities in a responsive grid.
 */
?>
<!-- wp:columns {"align":"wide","className":"feature-grid"} -->
